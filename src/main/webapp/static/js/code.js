...
judoStalkerControllers.controller('judokatCtrl', ["$scope", "Judoka", "kirjautuminen", "$stateParams", "Tekniikka", "Kommentti", "$state",
    function($scope, Judoka, kirjautuminen, $stateParams, Tekniikka, Kommentti, $state) {
